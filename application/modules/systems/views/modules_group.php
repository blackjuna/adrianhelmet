    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-footer">
          <button class="btn btn-success" onclick="add_module_group()"><i class="glyphicon glyphicon-plus"></i> Add</button>
...
function add_module_group()
{
    ...
    $('.modal-title').text('Add Module Groups'); // Set Title to Bootstrap modal title
}
...
function delete_module_groups(id)
{
...
function edit_module_groups(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
