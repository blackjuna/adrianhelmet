...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "columns": [
        { "data":"mdl_group_name","title": "MODULE GROUP NAME","width":"10%"  },
        { "data":"mdl_code","title": "MODULE CODE","width":"10%"  },
        { "data":"mdl_name","title": "MODULE NAME","width":"5%"  },
        { "data":"page_link","title": "PAGE LINK","width":"5%"  },
        { "data":"sort_no","title": "SORT NO","width":"5%"  },
        { "data":"show_in_menu","title": "SHOW","width":"5%"  },
        { "data":"icon","title": "ICON","width":"5%"  },
        { "data":"multilevel","title": "MULTILEVEL","width":"5%"  },
