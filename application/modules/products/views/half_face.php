<div class="span9">
	...
	<h4> New Products<small class="pull-right"> <?php echo count($this->Products_m->gethalfface_query()); ?> products are available </small></h4>	
	<hr class="soft"/>
		...
		<ul class="thumbnails">
			<?php
				...
				foreach($produk_list as $list){
					...
					echo '<li class="span3">
			 				<div class="thumbnail">';
					echo '<a href="'.site_url("products/details?id_product=".$list->id_product."").'">
						<img src="'.$link_image.'" alt="'.$list->product_name.'"/></a>';
