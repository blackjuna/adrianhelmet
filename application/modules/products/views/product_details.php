<div class="span9">
    ...
    <li><a href="<?= base_url();?>">Products</a> <span class="divider">/</span></li>
    <li class="active">product Details</li>
    </ul>	
	<div class="row">	  
			<div id="gallery" class="span3">
            <a href="<?= base_url();?>assets/themes-shop/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?= base_url();?>assets/themes-shop/images/products/large/3.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?= base_url();?>assets/themes-shop/images/products/large/f1.jpg"> <img style="width:29%" src="<?= base_url();?>assets/themes-shop/images/products/large/f1.jpg" alt=""/></a>
                   <a href="<?= base_url();?>assets/themes-shop/images/products/large/f2.jpg"> <img style="width:29%" src="<?= base_url();?>assets/themes-shop/images/products/large/f2.jpg" alt=""/></a>
                   <a href="<?= base_url();?>assets/themes-shop/images/products/large/f3.jpg" > <img style="width:29%" src="<?= base_url();?>assets/themes-shop/images/products/large/f3.jpg" alt=""/></a>
                  </div>
                  <div class="item">
                   <a href="<?= base_url();?>assets/themes-shop/images/products/large/f3.jpg" > <img style="width:29%" src="<?= base_url();?>assets/themes-shop/images/products/large/f3.jpg" alt=""/></a>
                   <a href="<?= base_url();?>assets/themes-shop/images/products/large/f1.jpg"> <img style="width:29%" src="<?= base_url();?>assets/themes-shop/images/products/large/f1.jpg" alt=""/></a>
		...
		<div class="tab-content">
			<div class="tab-pane" id="listView">
				<div class="row">	  
					<div class="span2">
						<img src="<?= base_url();?>assets/themes-shop/images/products/4.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
						<img src="<?= base_url();?>assets/themes-shop/images/products/5.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="<?= base_url();?>assets/themes-shop/images/products/6.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="<?= base_url();?>assets/themes-shop/images/products/7.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="<?= base_url();?>assets/themes-shop/images/products/8.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<hr class="soft"/>
				<div class="row">	  
					<div class="span2">
					<img src="<?= base_url();?>assets/themes-shop/images/products/9.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/10.jpg" alt=""/></a>
						<div class="caption">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/11.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/12.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/13.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/1.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?= base_url();?>assets/themes-shop/images/products/2.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
