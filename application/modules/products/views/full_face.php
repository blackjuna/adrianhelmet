<div class="span9">
	...
	<h4> New Products<small class="pull-right"> <?php echo count($this->Products_m->getfullface_query()); ?> products are available </small></h4>	
	<hr class="soft"/>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<?php
			$produk_list = $this->Products_m->gethalfface_query();
			foreach($produk_list as $list){
				...
				echo '<div class="row">	  
						<div class="span2">';
				echo '<img src="'.$link_image.'" alt="'.$list->product_name.'"/></div>';
		...
		<ul class="thumbnails">
			<?php
				...
				foreach($produk_list as $list){
					...
					echo '<li class="span3">
			 				<div class="thumbnail">';
					echo '<a href="'.site_url("invoices/add/".$list->id_product."").'"><img src="'.$link_image.'" alt="'.$list->product_name.'"/></a>';
