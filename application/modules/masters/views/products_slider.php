    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-footer">
          <button class="btn btn-success" onclick="add_slider()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
          <button class="btn btn-primary" onclick="edit_slider()"><i class="glyphicon glyphicon-pencil"></i> Ubah</button>
          <button class="btn btn-danger" onclick="delete_slider()"><i class="glyphicon glyphicon-remove"></i> Remove</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('masters/products_slider/r')?>",
            "type": "POST"
        },
        "columns": [
        { "data":"no","title": "NO" },
        { "data":"img_product","title": "GAMBAR" },
        { "data":"tittle","title": "JUDUL" },
        { "data":"note","title": "CATATAN" },
        { "data":"link","title": "TAUTAN" },
    ...
    $('#table tbody').on( 'click', 'tr', function () {
        ...
        id_slider = table.row( this ).data().id;
    } );
  });
...
function add_slider()
{
    ...
    $('.modal-title').text('Entri Slider'); // Set Title to Bootstrap modal title
}
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('masters/products_slider/c')?>";
    } else {
        url = "<?php echo site_url('masters/products_slider/u')?>";
    }
                ...
                <!-- <form enctype="multipart/form-data" accept-charset="utf-8" name="formname" id="formname"  action=""> -->
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan" id="catatan" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Tautan</label>
                            <div class="col-md-9">
                                <input type="text" name="tautan" id="tautan" placeholder="Tautan" class="form-control" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
