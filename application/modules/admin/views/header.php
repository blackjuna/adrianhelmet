...
<!--   <style type="text/css">
  ...
  <link rel="stylesheet" href="<?= base_url();?>assets/bootstrap-adminlte/dist/css/skins/_all-skins.min.css">
  ...
  <!-- SlimScroll -->
  <script src="<?= base_url();?>assets/bootstrap-adminlte/plugins/slimScroll/jquery.slimscroll.min.js"></script>
  <!-- FastClick -->
  <script src="<?= base_url();?>assets/bootstrap-adminlte/plugins/fastclick/fastclick.js"></script>
  <!-- AdminLTE App -->
  <script src="<?= base_url();?>assets/bootstrap-adminlte/dist/js/app.min.js"></script>  
